...
const translations = {
  en: {
    ...
    sections: {
      intro: "Keefa is <span style='font-weight: 800;'>a next-generation tech brand</span> focused on creating intelligent solutions that transform <span style='font-weight: 800;'>residential, commercial, and public spaces</span> into more <span style='font-weight: 800;'>robust and automated environments</span>.",
