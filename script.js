...
const translations = {
  en: {
    ...
    sections: {
      intro: "Keefa is <span style="font-weight: 900;">a next-generation tech brand</span> focused on creating intelligent solutions that transform <span style="font-weight: 900;">residential, commercial, and public spaces</span> into more <span style="font-weight: 900;">robust and automated environments</span>.",
